...
```ascii
    ╔════════════════════════════════════════════════════════════════════╗
    ║      🏡 GREEN VILLAGE - EUROPE'S LEADING MOBILE HOMES 🚀            ║
    ╚════════════════════════════════════════════════════════════════════╝
         ...
         ║| |▓▓▓|  |▓▓▓|  |▓▓▓|      |▓▓▓|  |▓▓▓|  |▓▓▓|  |▓▓▓|  |║
         ║|                                                        |║
         ║|        🏠 GREEN VILLAGE LUXURY MOBILE HOMES 🏠        |║
         ║|                                                        |║
         ║|  ___    ___    ___   ║║   ___    ___    ___    ___   |║
         ║| |▓▓▓|  |▓▓▓|  |▓▓▓|  ║║  |▓▓▓|  |▓▓▓|  |▓▓▓|  |▓▓▓|  |║
         ║|______________________|_DOOR_|______________________|║
         ║  ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀  ║
         ╚══════════════════════════════════════════════════════════╝

    💶 FROM €8,400 | 7 STORES 🇵🇹🇪🇸🇧🇷 | +3,000 MODELS | 🚚 FREE DELIVERY
    ═══════════════════════════════════════════════════════════════════
```
